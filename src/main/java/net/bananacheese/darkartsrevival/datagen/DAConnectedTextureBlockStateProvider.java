...
/**
 * DataGen provider for connected texture blocks
 * Generates blockstate JSON files automatically
 */

public class DAConnectedTextureBlockStateProvider extends FabricModelProvider {

    public DAConnectedTextureBlockStateProvider(FabricDataOutput output) {
        super(output);
    }

    @Override
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        // Models are generated through helper methods
    }

    @Override
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        // Item models handled separately
    }
